					...
					<table>
						...
						<cc:forEach items="${studentPage.records}" var="student">
							<tr>
								...
								<td>
								 <a href="UpdateStudent?id=${student.id}">更改</a>/
...
<%-- 					<p class="caption"><a href="${pageContext.request.contextPath}/Jsp/add.jsp">添加员工</a></p>
 --%>					
					<p class="caption">
					<a href="${pageContext.request.contextPath}/ListStudent?pageNo=1">首页</a>|
					<cc:if test="${studentPage.firstPage == false}">
					
					<a href="${pageContext.request.contextPath}/ListStudent?pageNo=${studentPage.prePage}">上一页</a>|
					</cc:if>
					...
					<a href="${pageContext.request.contextPath}/ListStudent?pageNo=${studentPage.nextPage}">下一页</a>|
					</cc:if>
					
					
					<a href="${pageContext.request.contextPath}/ListStudent?pageNo=${studentPage.totalPage}">尾页</a>
